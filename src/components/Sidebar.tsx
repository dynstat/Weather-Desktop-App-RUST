...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <div className="w-64 h-full glass-dark border-r border-emerald-500/10 flex flex-col">
          ...
          return (
            <Button
              ...
              className={`w-full justify-start space-x-3 h-12 ${
                isActive 
                  ? "bg-emerald-500/20 text-white shadow-glow border border-emerald-500/30" 
